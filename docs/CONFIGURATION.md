...
|---|---|---|
| `BASE_OUTPUT_PATH` | `C:/ComfyUI/output` | The folder the gallery shows. Write it however you like: backslashes or forward slashes, trailing slash or not, `~`, or the quotes Explorer's "Copy as path" adds. |
