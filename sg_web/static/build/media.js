...
(() => {
  ...
  async function ask(asked2, build2) {
    ...
    requireElement(box, ".ask-question", HTMLElement).textContent = asked2.question;
    if (asked2.detail !== void 0) {
      const line = requireElement(box, ".ask-detail", HTMLElement);
      line.textContent = asked2.detail;
      line.hidden = false;
    }
    const read = build2(requireElement(box, ".ask-body", HTMLElement), box);
    const feet = requireElement(box, ".ask-feet", HTMLElement);
    if (asked2.submit !== null) {
      feet.append(button(asked2.submit, TAKEN, asked2.grave === true ? "ask-take is-grave" : "ask-take"));
    }
    if (asked2.dismiss !== null) feet.append(button(asked2.dismiss, DISMISSED, "ask-drop"));
