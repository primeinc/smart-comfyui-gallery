...
days, percentages and name lists are formatted for display. Neither
touches a database, a model, or a template: they receive frozen values
and return strings. Jinja, elsewhere, lays the resulting StoryRender out.
...
surfaces, how a count, a day, a percent or a list of names is formatted.
