...
@pytest.fixture
def judged(tmp_path):
    root = tmp_path / "Ana's holiday"
    root.mkdir()
    for i in range(2):
        Image.new("RGB", (16, 12), (10 * i, 90, 140)).save(root / f"beach_{i}.png")
